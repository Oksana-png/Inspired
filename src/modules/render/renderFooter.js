...
`;
// элементы footer
const itemDevelopment = createElement('div', 
  {
  ...
  },
  {
    append: createElement('ul',
      {
        className: 'footer-developer__list',
      },
      {
        appends: [
          createElement('li',
          ...
          createElement('li',
            {
              className: 'footer-development',
              innerHTML: `
                Developer: <a class="footer__link" href="https://t.me/Oksa_na_web">Oksana Ovchinnikova</a>
              `
            }
          )
        ],
...
const itemCopyright = createElement('div',
  {
...
const listSocial = createElement('ul',
  {
      ...
      createElement('li',
        {
          ...
          innerHTML: `
            <a href="#" class="footer-social__link footer__link footer__link--vk">
              ${iconVK}
            </a>
          `,
        }
      ...
      createElement('li',
        {
          className: 'footer-social__item',
          innerHTML: `
            <a href="#" class="footer-social__link footer__link footer__link--fb">
              ${iconFB}
            </a>
          `,
        }
    ...
    <div class="container">
      <div class="footer__container">
        ...
        <div class="footer__item footer__item--development footer-development">
          <ul class="footer-developer__list">
